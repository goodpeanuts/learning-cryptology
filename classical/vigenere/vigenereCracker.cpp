 ...
 * @LastEditTime: 2023-12-11 14:44:24
...
std::string get_possible_key(std::string origin, size_t period)
{
    ...
    for (int i = 0; i < 15 * period; i++)
        std::cout << "=";
    std::cout << std::endl;
    std::cout << "All In the Caeser cipher crack " << std::endl
              << std::endl;
    std::cout << std::left << std::setw(10) << "Number" << std::setw(10) << "Letter";
    for (size_t i = 0; i < period; ++i)
        std::cout << std::setw(15) << "Chi-Square" + std::to_string(i + 1);
    std::cout << std::endl;

    char letter{'a'};
    for (int i = 0; i < 26; ++i)
    {
        std::cout << std::setw(10) << i << std::setw(10) << letter++ << "";
        for (size_t j = 0; j < period; ++j)
        {
            std::cout << std::setw(15) << chi_tables.at(j).at(i);
        }
        std::cout << std::endl;
    }
    std::cout << "==================";
    ...
    std::cout << "The  digit of key (descending order by possibility): " << std::endl;
    std::cout << "=======================================================" << std::endl;
    ...
    std::cout << std::endl
              << "Possible key: " << possible_key << std::endl;
    return possible_key;
}
